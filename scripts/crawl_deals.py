...
def main():
    ...
    templates = [
        ...
        {"from_code": "PEK", "from_city": "北京", "to_code": "CAN", "to_city": "广州", "basePrice": 850, "source": "飞猪", "airline": "中国国航", "tags": ["直飞", "含托运"], "rec": "最省时", "recReason": "黄金航线", "img": "https://images.unsplash.com/photo-1555979864-7493b296ac52?w=800", "region": "domestic"},
        {"from_code": "CTU", "from_city": "成都", "to_code": "SZX", "to_city": "深圳", "basePrice": 620, "source": "去哪儿", "airline": "深圳航空", "tags": ["准点率高", "含餐食"], "rec": "体验好", "recReason": "宽体机执飞", "img": "https://images.unsplash.com/photo-1529944208035-7cfa574bb5a9?w=800", "region": "domestic"},
        ...
        {"from_code": "BJS", "from_city": "北京", "to_code": "HGH", "to_city": "杭州", "basePrice": 580, "source": "携程", "airline": "海航", "tags": ["直飞", "极速出票"], "rec": "西湖韵", "recReason": "美景推荐", "img": "https://images.unsplash.com/photo-1541123437220-72c5ef216306?w=800", "region": "domestic"},
